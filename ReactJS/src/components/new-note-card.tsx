...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleContentChance(event: ChangeEvent<HTMLTextAreaElement>) {
  ...
  function handleStartRecording() {
    ...
    speechRecognition.maxAlternatives = 1 // possibilidade mais próxima do q ele acha q é, trazer uma opção 
    speechRecognition.interimResults = true //trazendo os resultados conforme vou falando
          ...
          <form className="flex-1 flex flex-col">
            ...
            { isRecording ? (
             ...
             >
                ...
                Gravando! (Clique pra interromper)
             </button>
            ) : (
              <button 
                type="button"
