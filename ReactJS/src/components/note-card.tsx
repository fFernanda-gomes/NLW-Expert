...
/*
  Root --> 
  Trigger --> sempre no elemento que vai abrir o modal
  Content --> o que vai aparecer quando clicar no modal
  Portal --> faz com que o contéudo dentro dele não seja exatamente mostrado onde foi colocado, manda pra raiz
  Overlay --> div que faz com que o modal pareça estar acima, dx a tela preta
*/